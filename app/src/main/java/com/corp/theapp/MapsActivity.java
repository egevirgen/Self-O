...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, LocationListener,SearchView.OnQueryTextListener{
    ...
    public void Initialize(){
        ...
        searchEditText = (EditText) editsearch.findViewById(editsearch.getContext().getResources().getIdentifier("android:id/search_src_text", null, null));
        ...
        mBottomSheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet_1, int newState) {
                ...
                if (newState == BottomSheetBehavior.STATE_EXPANDED) {
                    ...
                    if(ivIcon!=null) {
                        ivIcon.setImageResource(R.drawable.search_back_button);
                    }
    ...
    public void Location(final String type) {
